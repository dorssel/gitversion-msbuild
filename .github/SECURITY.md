...
Please consult the [Security Advisories](https://github.com/dorssel/gitversion-msbuild/security/advisories) for any known
outstanding security vulnerabilities in the latest release.

## Reporting a Vulnerability

Please [report vulnerabilities](https://github.com/dorssel/gitversion-msbuild/security/advisories/new) privately,
